...
\restrict ObKwdLAXK9F9KGhKkPo3VNj8e1GwgkqdTbfHTo0UEbHz6bUgw87HksLzceaLKIu
...
begin
  ...
  return jsonb_build_object('conexoes', qtd_conexoes, 'contas', qtd_contas, 'transacoes', qtd_transacoes);
end;
$$;
...
CREATE VIEW public.vw_compromisso_cartao_por_pessoa WITH (security_invoker='true') AS
 SELECT u.nome AS usuario_nome,
  ...
  WHERE ((t.afeta_saldo_real = false) AND (t.cartao_id IS NOT NULL) AND ((c.ciclo_inicio_em IS NULL) OR (t.data >= c.ciclo_inicio_em) OR (t.data IS NULL)))
...
--
-- Name: wallace_dados Escrita via service role; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Escrita via service role" ON public.wallace_dados USING ((auth.role() = 'service_role'::text));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.caixas FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.cartoes FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.categorias FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.ciclos_financeiros_snapshots FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.ciclos_solares FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.contas_bancarias FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.cronograma_boletos_fixos FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.emprestimos_internos FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.energia_solar_geracao_diaria FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.energia_solar_leituras FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.financiamentos FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.indicadores FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.investimentos FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.mercadopago_eventos FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.metas FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.parcelas FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.patrimonio FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.pluggy_conexoes FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.pluggy_contas FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.pluggy_transacoes FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.reembolso_wartsila_ciclo FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.reembolso_wartsila_recebimentos FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.reembolsos FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.regras_classificacao FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.regras_resolver_caixa FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.subcategorias FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.transacoes FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.usuarios FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY "Leitura restrita a login Firebase valido" ON public.v1_v2_caixa_mapa FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));


--
-- Name: wallace_dados Leitura restrita a login Firebase valido; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Leitura restrita a login Firebase valido" ON public.wallace_dados FOR SELECT USING (((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text)));
...
CREATE POLICY pluggy_triagem_select_autenticado ON public.pluggy_triagem FOR SELECT USING (((auth.role() = 'service_role'::text) OR ((auth.jwt() IS NOT NULL) AND ((auth.jwt() ->> 'iss'::text) = 'https://securetoken.google.com/sistema-wallace-lira'::text) AND ((auth.jwt() ->> 'aud'::text) = 'sistema-wallace-lira'::text))));
...
\unrestrict ObKwdLAXK9F9KGhKkPo3VNj8e1GwgkqdTbfHTo0UEbHz6bUgw87HksLzceaLKIu
