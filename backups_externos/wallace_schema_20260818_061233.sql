...
\restrict bipNrVheB9fEZfSeCFGhUVNHXYPmUoOqYcA5oENogxo1yvtVm42nzG2j77LKxES
...
BEGIN
  ...
  INSERT INTO medidor_tuya_leituras (tensao_v, corrente_a, potencia_w, energia_hoje_kwh, energia_total_kwh, estado)
  VALUES (
    (leitura->>'tensao_v')::numeric,
    (leitura->>'corrente_a')::numeric,
...
BEGIN
  ...
  FROM medidor_tuya_leituras t ORDER BY t.capturado_em DESC LIMIT 1;
  ...
  -- NOVO 17/08/2026: consumo diario persistido (medidor_tuya_consumo_diario) - usado pra somar o
  -- consumo real desde o inicio do CICLO DA GD (dataInicio de ciclo_aberto), mesma logica ja usada
  -- no painel privado (card "Consumo real x credito").
  ...
  FROM medidor_tuya_consumo_diario d;
...
BEGIN
  ...
  INSERT INTO medidor_tuya_consumo_diario (data, kwh_consumido, atualizado_em)
  VALUES (v_dia, GREATEST(0, ROUND(NEW.energia_total_kwh - v_baseline, 3)), now())
...
ALTER TABLE ONLY public.medidor_tuya_consumo_diario
    ADD CONSTRAINT medidor_tuya_consumo_diario_pkey PRIMARY KEY (data);
...
\unrestrict bipNrVheB9fEZfSeCFGhUVNHXYPmUoOqYcA5oENogxo1yvtVm42nzG2j77LKxES
