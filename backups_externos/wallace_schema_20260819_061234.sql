...
\restrict rweuKUPd5WE7K73sdhfczpr56WxP39jfe0S43mMFMXIuc3yZh68fALKTrd2mHOb
...
BEGIN
  ...
  -- NOVO 18/08/2026: telemetria mais recente do medidor da Wellida (mesmo padrao do Wallace acima),
  -- pro card "Consumo em tempo real" no compartilhado que ainda faltava (so tinha a comparacao).
  SELECT jsonb_build_object(
    'capturadoEm', t.capturado_em, 'tensaoV', t.tensao_v, 'correnteA', t.corrente_a,
    'potenciaW', t.potencia_w, 'energiaHojeKwh', t.energia_hoje_kwh,
    'energiaTotalKwh', t.energia_total_kwh, 'estado', t.estado
...
\unrestrict rweuKUPd5WE7K73sdhfczpr56WxP39jfe0S43mMFMXIuc3yZh68fALKTrd2mHOb
