...
// sessão em que este scaffold foi escrito — colunas reais de
// vw_saldo_v2_por_caixa, caixas, cartoes, usuarios, categorias, subcategorias,
// transacoes e a assinatura de lancar_transacao_manual/rpc_dashboard_resumo.
// Se o schema mudar depois, reconferir antes de confiar cegamente neste
// arquivo (Nível B do manual: "código lido nesta sessão" perde validade
// assim que o schema muda sem este arquivo ser atualizado junto).
 ...
 * do modelo — só o código de confirmação em server.js/conversation pode
 ...
 * (`lancar_transacao_whatsapp_agent`, por exemplo, envolvendo os dois
