...
function criarVarsEnergiaSolar(){
  ...
  ENERGISA_TARIFA_COMPOSICAO: {
    // fatura_pre_solar_valor/_consumo_kwh (19/08/2026, achado do usuário) = jul/26, a última fatura
    // real ANTES do crédito solar entrar na conta — congelada de propósito, ver graficos-cenarios-lazy.js.
    apartamento_wallace: { uc:'1.994.775.053-05', historico:{ mai26:270.10, jun26:322.99, jul26:367.36 }, fatura_pre_solar_valor:367.36, fatura_pre_solar_consumo_kwh:350, composicao_pct:{ energia:28, impostos:22, distribuicao:22, iluminacao:12, encargos:12, transmissao:5 } },
    ...
    // fatura_pre_solar_valor/_consumo_kwh (19/08/2026) = jul/26 — kwh (90) confirmado via PDF real da
    // Nota Fiscal 081.896.112 (leitura 16011->16101), batendo exato com o R$94,45 já salvo.
    casa_wellida: { uc:'2.064.202.053-60', historico:{ mai26:141.82, jun26:106.23, jul26:94.45, ago26:70.12 }, fatura_ago26_valor:70.12, fatura_ago26_consumo_kwh:111, fatura_pre_solar_valor:94.45, fatura_pre_solar_consumo_kwh:90, cosip_valor_real:13.87, composicao_pct:{ energia:24.04, impostos:43.15, distribuicao:18.56, iluminacao:0, encargos:10.15, transmissao:4.10 } },
    // fatura_pre_solar_valor/_consumo_kwh (19/08/2026) = jul/26, já tinha o kwh registrado
    // (fatura_jul26_consumo_kwh) — congelado, único caso dos 3 com o par completo pré-solar.
    casa_mae: { uc:'573.702.053-77', fatura_jul26_valor:203.61, fatura_jun26_valor:301.54, fatura_jul26_consumo_kwh:194, fatura_ago26_valor:56.11, fatura_ago26_consumo_kwh:145, fatura_ago26_injetada_kwh:339, fatura_pre_solar_valor:203.61, fatura_pre_solar_consumo_kwh:194, cosip_valor_real:18.12, composicao_pct:{ energia:15.92, impostos:62.40, distribuicao:12.25, iluminacao:0, encargos:6.72, transmissao:2.71 } },
  },
