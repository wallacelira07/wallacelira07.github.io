...
function criarVarsOperacional(){
  ...
  LEGENDAS: {
    ...
    legPGVSaldoResidual: `Saldo real da Caixa Pix Geral: <strong>R$ 306,73</strong>. Fonte: V2 pura (tabela transações), sem depender mais do array V1 — resolvido em 09/08/2026 após a caixa mostrar R$50,73 por causa de 3 lançamentos (Abastecimento +R$300, Fruta -R$4, Sabão -R$40) que existiam na V2 mas nunca tinham sido espelhados no V1. A view agora usa caixas.ciclo_inicio_em (24/07 pra esta caixa) em vez do array legado — qualquer lançamento confirmado dentro do ciclo já aparece aqui automaticamente, sem sincronização manual.`,
