...
function hydrateBalanco(){
  ...
  // REMOVIDO 15/08/2026 (pedido do usuário: "Pendente acumulado, não comunica nada") — indicador
  // separado (VARS.faturaMPCorporativoPendente/#balReembolsoWartsilaAcumulado) tirado do card. Ficava
  // travado em confirmação desde 09/08 (dúvida se já estava contido no Amount Due Employee da
  // Wärtsilá) sem nunca resolver — decisão do usuário foi remover em vez de manter aberto.
