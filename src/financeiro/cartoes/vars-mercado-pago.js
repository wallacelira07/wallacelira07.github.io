...
function criarVarsMercadoPago(){
  ...
  cartaoMBTotal: 5911.62,               // CORRIGIDO 07/08/2026 (+7,44): mbLRWConfirmado subiu de 1348,73->1356,17 (IOF do TX000200/TX000205 que faltava, ver comentário de mbLRWConfirmado) - total mestre reajustado junto, senão quebra a checagem #12 da auditoria automática (soma mbDetalhe ≠ cartaoMBTotal). mbDetalhe (1950,77 consórcios+1356,17 wallace+1279,65 recorrências+297,31 corp+663,10 assinaturas+364,62 vanessa) soma exato 5.911,62. Era R$5.904,18 (sincronização Supabase 07/08, antes do fix do IOF) - ver histórico completo de correções anteriores no Supabase.
  ...
  mbLRWConfirmado: 1356.17,       // SINCRONIZADO 07/08/2026 (fonte: Supabase): TX000203 Sorveteria Papa Açaí +61,15 + TX000205 ANTHROPIC*CLAUDE SUB (compra única, não é renovação de assinatura) +113,72 (com IOF). Era R$1.177,58 (04/08/2026, parte 68). CORRIGIDO 07/08/2026 (+7,44): TX000200 e TX000205 estavam sem o IOF de 3,38% somado no valor (bug encontrado e corrigido nos 2, ver comentários das transações) - ver histórico completo de correções anteriores no Supabase.
