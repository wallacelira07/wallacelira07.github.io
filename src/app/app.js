...
// NOVO 19/08/2026 (achado do usuário: "por que não aparece aqui o valor de terceiro?" — compra
// reembolsável de terceiro, seção 23 do manual, faltava na Fatura Mercado Pago). Ver
// hydrate-mercado-pago-terceiros-v2.js. Roda DEPOIS de hydrateMercadoPago() (dentro de hydrate(),
// já executada antes deste onDomPronto) pra poder sobrescrever o texto de #mpFatura se precisar.
onDomPronto(aplicarMercadoPagoTerceirosV2);
