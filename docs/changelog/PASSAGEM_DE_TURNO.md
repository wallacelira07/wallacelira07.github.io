...
Os outros 7 achados (N+1 do `FinanceService`, formulário de lançamento manual fora do design system, botão pill sem classe reutilizável, Chart.js recriado do zero, `new Function` pra módulos) ficam de backlog, registrados em `ESTADO_ATUAL.md`.
