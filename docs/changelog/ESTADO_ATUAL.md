...
| Item | Prioridade |
|---|---|
| Leitura de 09/08 em `energia_solar_leituras` ficou com `geracao_acumulada=NULL` pra sempre (a menos que o usuário informe o total real daquele dia pra lançar manual) — não é mais um bug ativo, é só um buraco histórico de 1 dia | Média — não fabricar o número, só o usuário tem o dado real (print do Elekeeper de 09/08) |
