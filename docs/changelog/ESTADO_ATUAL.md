...
- [x] Fase 1b concluída — `rpc_necessidade_total_bruta` reescrita, determinística (Regra 1 aprovada 22/08/2026), validada. Ver item 10-12 do resumo executivo.
- [ ] Trocar o consumo no site (JS) pela RPC — hoje ela existe no banco e bate exato, mas o site ainda calcula tudo localmente. Passo separado, aguardando decisão do usuário pra iniciar.
