...
// scripts/database/*.py) e pelo protótipo irmão whatsapp-agent/: SUPABASE_URL
// + SUPABASE_SERVICE_ROLE_KEY, chamando /rest/v1/<tabela> e
// /rest/v1/rpc/<funcao> direto, sem SDK extra.
